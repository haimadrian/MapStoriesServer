...
public class UserControllerTest {
   ...
   void testUserInfo_correctUserToken_success() throws Exception {
      ...
      // Second, test.
      mockMvc.perform(get("/user/info/charizard@pokemon.com").secure(true).header(AUTHORIZATION_HEADER, TestUtils.getJwtTokenFromMvcResult(response)))
            .andExpect(status().isOk())
   ...
   void testUserInfo_wrongUserToken_fail() throws Exception {
      ...
      // Second, test.
      mockMvc.perform(get("/user/info/charizard@pokemon.com").secure(true).header(AUTHORIZATION_HEADER, "wrongAuth"))
